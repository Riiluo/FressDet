...
def _get_covariance_matrix(boxes):  # 将旋转边界框(OBB)转换为高斯分布的协方差矩阵。
    """
...
def probiou(obb1, obb2, CIoU=False, eps=1e-7):
    ...
    """
    x1, y1 = obb1[..., :2].split(1, dim=-1)  # gt
    x2, y2 = obb2[..., :2].split(1, dim=-1)  # pred
    ...
    iou = 1 - hd
    if CIoU:  # only include the wh aspect ratio part  # False
