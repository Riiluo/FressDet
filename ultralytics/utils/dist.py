...
def generate_ddp_file(trainer):
    ...
    # Ensure the spawned DDP worker imports the same ultralytics package (repo checkout vs site-packages).
    # Using save_dir parents is fragile (depends on project/name depth), so derive from this file location.
